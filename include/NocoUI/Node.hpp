...
namespace noco
{
	...
	public:
		...
		void update(const std::shared_ptr<Node>& scrollableHoveredNode, double deltaTime, const Mat3x2& parentTransformMat, const Mat3x2& parentHitTestMat, const HashTable<String, std::shared_ptr<Param>>& params, const Array<String>& parentActiveStyleStates = {});

		void lateUpdate();

		void postLateUpdate(double deltaTime, const HashTable<String, std::shared_ptr<Param>>& params);

		void refreshTransformMat(RecursiveYN recursive, const Mat3x2& parentTransformMat, const Mat3x2& parentHitTestMat, const HashTable<String, std::shared_ptr<Param>>& params);
