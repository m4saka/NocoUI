...
namespace noco
{
	...
	void Canvas::refreshLayout()
	{
		...
		m_rootNode->refreshPosScaleAppliedRect(RecursiveYN::Yes, rootPosScaleMat(), m_scale, rootPosScaleMat(), 0.0);
	}
	...
	void Canvas::update(HitTestEnabledYN hitTestEnabled)
	{
		...
		m_rootNode->update(scrollableHoveredNode, Scene::DeltaTime(), rootPosScaleMat(), m_scale, rootPosScaleMat(), 0.0, {});
